...
export default async function ProjectPage({
  ...
  return (
    <>
      <section className="page-intro case-intro navy">
        <div className="container">
          <Link href="/work" className="text-link text-cream! mb-8">
            <span aria-hidden="true">←</span> All work
          </Link>
          <p className="eyebrow">
            {project.featured ? "Case study" : "Project overview"} /{" "}
            ...
            <div className="prose">
              ...
              {project.evidence && (
                <section>
                  ...
                  <a className="text-link" href={project.evidence.href}>
      ...
      <section className="section soft">
        <div className="container">
          ...
          <h2 className="max-w-3xl">{related.title}</h2>
          <Link className="text-link mt-6" href={`/work/${related.slug}`}>
